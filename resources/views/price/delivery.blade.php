<template id="delivery-template">
  <div>
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-sm">
            <tr class="table-primary">
                ...
                <button class="btn btn-sm btn-success float-right" data-toggle="modal" data-target="#delivery_modal" @click="createSingleEntry()">
    ...
    <div ref="modal" class="modal" id="delivery_modal" v-if="form">
            ...
            <div class="modal-content">
                <div class="modal-header back-happyrent-light-green text-white">
                    <div class="modal-title">
                        @{{ action === 'update' ? 'Edit Delivery' : 'New Delivery' }}
                    </div>
