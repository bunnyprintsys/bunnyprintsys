<template id="delivery-method-template">
  <div>
        ...
        <table class="table table-bordered table-sm">
            <tr class="table-primary">
                <th class="text-center" colspan="12">
                  Delivery Method
                  <button class="btn btn-sm btn-success float-right" data-toggle="modal" data-target="#delivery_method_modal" @click="createSingleEntry()">
            ...
            <tr v-for="(data, index) in delivery_methods" class="row_edit">
  ...
  <div ref="modal" class="modal" id="delivery_method_modal" v-if="form">
          ...
          <div class="modal-content">
              <div class="modal-header back-happyrent-light-green text-white">
                  <div class="modal-title">
                      @{{ action === 'update' ? 'Edit Delivery Method' : 'New Delivery Method' }}
                  </div>
