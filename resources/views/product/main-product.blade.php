<template id="main-product-template">
  <div>
        ...
        <table class="table table-bordered table-sm">
            <tr class="table-primary">
                <th class="text-center" colspan="12">
                  Main Product
                  <button class="btn btn-sm btn-success float-right" data-toggle="modal" data-target="#main_product_modal" @click="createSingleEntry()">
            ...
            <tr v-for="(data, index) in statuses" class="row_edit">
  ...
  <div ref="modal" class="modal" id="status_modal" v-if="form">
          ...
          <div class="modal-content">
              <div class="modal-header back-happyrent-light-green text-white">
                  <div class="modal-title">
                      @{{ action === 'update' ? 'Edit Status' : 'New Status' }}
                  </div>
