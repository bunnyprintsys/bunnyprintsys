@extends('layouts.app')
@section('header')
    <a href="/admin" class="btn btn-sm back-happyrent-light-green">
...
<template id="index-admin-template">
  <div>
    <div class="card">
      <div class="card-header">
          ...
          <button type="button" class="btn bg-primary text-white btn-sm ml-auto" data-toggle="modal" data-target="#admin_modal" @click="createSingleAdmin">
      ...
      <div class="card-body">
        ...
        <div class="form-row">
            <div class="form-group col-md-3 col-sm-6 col-xs-12">
                ...
                <input type="text" name="name" class="form-control" v-model="search.name" placeholder="Admin Name" autocomplete="off" @keyup="onFilterChanged">
            </div>
            <div class="form-group col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    <tr class="table-secondary">
                        ...
                        <th class="text-center">
                            <a href="#" @click="sortBy('join_date')">Join Date</a>
                            <span v-if="sortkey == 'join_date' && !reverse" class="fa fa-caret-down"></span>
                            <span v-if="sortkey == 'join_date' && reverse" class="fa fa-caret-up"></span>
                        </th>
                        <th></th>
                    </tr>
                    ...
                    <tr v-for="(data, index) in list" class="row_edit">
                        ...
                        <td class="text-center">
                            ...
                            <button type="button" class="btn btn-danger btn-sm" @click="toggleUserStatus(data,3)">
                                <i class="fas fa-ban"></i>
                            </button>
                            <button type="button" class="btn btn-light btn-outline-secondary btn-sm" data-toggle="modal" data-target="#admin_modal" @click="editSingleAdmin(data)">
    ...
    <form-admin @updatetable="searchData" :clearform="clearform" :data="formdata"></form-admin>
  </div>
</template>
