if (document.querySelector('#indexMemberController')) {
    Vue.component('index-member', {
      template: '#index-member-template',
      data() {
        return {
          list: [],
          unit_options: [],
    ...
    Vue.component('form-member', {
      template: '#form-member-template',
